...
wmt.utils = {
	...
	"alert" : function(aMessage) {
		alert(wmt.utils.createMessage(aMessage, Array.prototype.slice.call(
			arguments, 1)));
	},

	"log" : function(aMessage) {
		console.log(wmt.utils.createMessage(aMessage, Array.prototype.slice
			.call(arguments, 1)));
	},
